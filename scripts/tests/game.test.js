...
describe("game object contains correct key", () => {
    ...
    test("turns in progress key exists", () => {
        expect("turnsInProgress" in game).toBe(true);
    });

    test("turns in progress key defaults false", () => {
        expect(game.turnsInProgress).toBe(false);
    });
...
describe("newGame works correctly", () => {
    ...
    test("should set playerMoves array to blank", () => {
